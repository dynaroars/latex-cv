...
\begin{itemize}
    ...
    \begin{itemize}
    \item '26 (on going), '25 (\textbf{7x}\footnote{In 2025, NSF faced many uncertainties and organizational changes, which made it difficult for program managers to find people willing to serve on panels and further caused delays in reviews. So I made an effort to say ``yes'' to all invitations to panels aligned with my expertise, to support NSF and the U.S. funding landscape (though the trade-off was saying ``no'' to most invitations to conference program committees and journal reviews!).}), '24 (4x), '23 (2x), '22 (2x), '21 (1x), '20 (1x), '19 (1x)
    \end{itemize}
