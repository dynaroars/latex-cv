...
\usepackage[backend=biber,doi=false,isbn=false,maxcitenames=10,maxbibnames=10,abbreviate=false,style=alphabetic]{biblatex}
...
}
{
  ...
  \begin{minipage}{.3\textwidth}
    \includegraphics[width=0.4\textwidth]{../docs/files/tvn.png}
  \end{minipage}
